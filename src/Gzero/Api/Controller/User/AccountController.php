...
class AccountController extends ApiController {
    ...
    public function update(Request $request)
    {
        ...
        $validator = $this->validator->bind('nick', ['user_id' => $user->id]);

        // user should be able to update account without changing email generated by social integrations
        if ($request->get('email') === $request->user()->email) {
            $input = $validator->validate('update_without_email');
        } else {
            $input = $validator->bind('email', ['user_id' => $user->id])->validate('update');
        }
