define({ "api": [
  {
    ...
    "description": "<p>Updates the specified content from database</p> ",
    "success": {
      "fields": {
        "Success 200": [
          {
  ...
  },
  {
    ...
    "title": "2. GET collection of entities",
    "version": "0.1.0",
  ...
  },
  {
    ...
    "description": "<p>Stores newly created content in database</p> ",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://api.example.com/api/v1/admin/contents",
  ...
  },
  {
    ...
    "description": "<p>Updates the specified content in database</p> ",
    "examples": [
      {
        "title": "Example usage:",
        "content": "curl -i http://api.example.com/api/v1/admin/contents",
